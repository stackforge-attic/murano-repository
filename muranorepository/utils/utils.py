...
from muranorepository.consts import HASH_FOLDER_NAME
CONF = cfg.CONF
...
def get_tenant_folder():
    return os.path.join(CONF.cache_dir,
                        SERVICE_DEFINITIONS_FOLDER_NAME,
                        get_tenant_id())


def get_cache_folder():
    return os.path.join(CONF.cache_dir, HASH_FOLDER_NAME,  get_tenant_id())
